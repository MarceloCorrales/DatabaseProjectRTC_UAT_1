...
--exec  [dbo].[sp_TruckPaperCleanseDataGaps]

CREATE PROCEDURE [dbo].[sp_TruckPaperCleanseDataGaps_NOSubCategory]
AS
...
/** Fill in data gaps in years for each make and model **/
	...
	--3500HD	1998
      ...
      TRUNCATE TABLE dbo.TruckPaperEquipmentYearGaps;
	  INSERT TruckPaperEquipmentYearGaps
     SELECT A.*,
            CASE
         ...
         BEGIN
             ...
             FOR
                 SELECT [MAKE],
                        ...
                        [IsValue],
                        [AvgPrice]
                 FROM [dbo].[TruckPaperEquipmentYearGaps](NOLOCK)
				    ...
				    --print 'isvalue: ' + cast(@IsValue as varchar)
                     IF @IsValue = 0
                         ...
                         BEGIN
                             ...
                             UPDATE TruckPaperEquipmentYearGaps
                               SET
                                   DiffPrice = @diffprice
                             WHERE Make = @make
                                   AND Model = @model
