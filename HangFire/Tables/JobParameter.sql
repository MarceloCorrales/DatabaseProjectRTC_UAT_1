...
GO
ALTER TABLE [HangFire].[JobParameter] NOCHECK CONSTRAINT [FK_HangFire_JobParameter_Job];
...
GO
ALTER INDEX [IX_HangFire_JobParameter_JobIdAndName]
    ON [HangFire].[JobParameter] DISABLE;
